  ...
  <section class="section main-banner" id="top" data-section="section1">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            ...
            <h6>Online Campus Discusion Forum</h6>
            <h2>Meet with other Students of <em>Al-Hikmah </em></h2>
      ...
      <div class="owl-carousel owl-theme">
        <div class="item">
          ...
          <div class="down-content">
            ...
            <div class="author-image">
              <img src="{{asset('assets/images/matric.jpeg')}}" alt="Author 1">
            </div>
        ...
        <div class="item">
          ...
          <div class="down-content">
            ...
            <div class="author-image">
              <img src="{{asset('assets/images/1.jpeg')}}" alt="Author 2">
            </div>
        ...
        <div class="item">
          ...
          <div class="down-content">
            ...
            <div class="author-image">
              <img src="{{asset('assets/images/2.jeg')}}" alt="Author 3">
            </div>
            <div class="text-button-pay">
              <a href="#">Pay <i class="fa fa-angle-double-right"></i></a>
            </div>
        ...
        <div class="item">
          ...
          <div class="down-content">
            ...
            <div class="author-image">
              <img src="{{asset('assets/images/3.jpeg')}}" alt="Author 4">
            </div>
            <div class="text-button-free">
              <a href="#">Free <i class="fa fa-angle-double-right"></i></a>
            </div>
